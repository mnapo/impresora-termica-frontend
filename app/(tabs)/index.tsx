...
export default function TabsHome() {
  ...
  return (<PaperProvider><Portal>
    <Modal visible={visible} onDismiss={ () => { setVisible(false) } } contentContainerStyle={styles.modal}>
      <Button mode="contained" onPress={() => handlePress('arca') } icon="file" style={{ marginVertical: 5}} uppercase={true} labelStyle={{ fontSize: 24 }} buttonColor='#429E9D' textColor='white' >factura ARCA</Button>
      <Button mode="contained" onPress={() => handlePress('comprobante') } icon="content-paste" style={{ marginVertical: 5}} uppercase={true} labelStyle={{ fontSize: 24 }} buttonColor='#429E9D' textColor='white' >comprobante</Button>
